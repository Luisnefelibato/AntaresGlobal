...
<section class="py-24 lg:py-32 bg-antares-dark">
  <div class="container mx-auto px-4 sm:px-6 lg:px-8">
    ...
    <div id="projects-grid" class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
      ...
      <!-- Design Project 5 - Felix Chevrolet -->
      <div class="project-card group relative h-96 rounded-2xl overflow-hidden" data-category="design">
        <img src="/static/images/project-design-5.jpg" alt="Felix Chevrolet Logo Design" class="w-full h-full object-cover transition-transform duration-500 group-hover:scale-110">
        <div class="absolute inset-0 bg-gradient-to-t from-black via-black/60 to-transparent opacity-80 group-hover:opacity-90 transition-opacity"></div>
        <div class="absolute inset-0 p-6 flex flex-col justify-end">
      ...
      <!-- Production Project 5 - Felix Chevrolet -->
      <div class="project-card group relative h-96 rounded-2xl overflow-hidden" data-category="production">
        <img src="/static/images/project-production-5.jpg" alt="Felix Chevrolet Sign Production" class="w-full h-full object-cover transition-transform duration-500 group-hover:scale-110">
        <div class="absolute inset-0 bg-gradient-to-t from-black via-black/60 to-transparent opacity-80 group-hover:opacity-90 transition-opacity"></div>
        <div class="absolute inset-0 p-6 flex flex-col justify-end">
      ...
      <!-- Installation Project 5 - Felix Chevrolet -->
      <div class="project-card group relative h-96 rounded-2xl overflow-hidden" data-category="installation">
        <img src="/static/images/project-installation-5.jpg" alt="Felix Chevrolet Monument Sign Installation" class="w-full h-full object-cover transition-transform duration-500 group-hover:scale-110">
        <div class="absolute inset-0 bg-gradient-to-t from-black via-black/60 to-transparent opacity-80 group-hover:opacity-90 transition-opacity"></div>
        <div class="absolute inset-0 p-6 flex flex-col justify-end">
      ...
      <!-- Design Project 6 - Clineva Urgent Care -->
      <div class="project-card group relative h-96 rounded-2xl overflow-hidden" data-category="design">
        <img src="/static/images/project-design-6.jpg" alt="Clineva Urgent Care Logo Design" class="w-full h-full object-cover transition-transform duration-500 group-hover:scale-110">
        <div class="absolute inset-0 bg-gradient-to-t from-black via-black/60 to-transparent opacity-80 group-hover:opacity-90 transition-opacity"></div>
        <div class="absolute inset-0 p-6 flex flex-col justify-end">
      ...
      <!-- Production Project 6 - Clineva Urgent Care -->
      <div class="project-card group relative h-96 rounded-2xl overflow-hidden" data-category="production">
        <img src="/static/images/project-production-6.jpg" alt="Clineva Urgent Care Sign Production" class="w-full h-full object-cover transition-transform duration-500 group-hover:scale-110">
        <div class="absolute inset-0 bg-gradient-to-t from-black via-black/60 to-transparent opacity-80 group-hover:opacity-90 transition-opacity"></div>
        <div class="absolute inset-0 p-6 flex flex-col justify-end">
      ...
      <!-- Installation Project 6 - Clineva Urgent Care -->
      <div class="project-card group relative h-96 rounded-2xl overflow-hidden" data-category="installation">
        <img src="/static/images/project-installation-6.jpg" alt="Clineva Urgent Care Channel Letters Installation" class="w-full h-full object-cover transition-transform duration-500 group-hover:scale-110">
        <div class="absolute inset-0 bg-gradient-to-t from-black via-black/60 to-transparent opacity-80 group-hover:opacity-90 transition-opacity"></div>
        <div class="absolute inset-0 p-6 flex flex-col justify-end">
      ...
      <!-- Design Project 7 - Family Dentistry -->
      <div class="project-card group relative h-96 rounded-2xl overflow-hidden" data-category="design">
        <img src="/static/images/project-design-7.jpg" alt="Family Dentistry Logo Design" class="w-full h-full object-cover transition-transform duration-500 group-hover:scale-110">
        <div class="absolute inset-0 bg-gradient-to-t from-black via-black/60 to-transparent opacity-80 group-hover:opacity-90 transition-opacity"></div>
        <div class="absolute inset-0 p-6 flex flex-col justify-end">
      ...
      <!-- Production Project 7 - Family Dentistry -->
      <div class="project-card group relative h-96 rounded-2xl overflow-hidden" data-category="production">
        <img src="/static/images/project-production-7.jpg" alt="Family Dentistry Sign Production" class="w-full h-full object-cover transition-transform duration-500 group-hover:scale-110">
        <div class="absolute inset-0 bg-gradient-to-t from-black via-black/60 to-transparent opacity-80 group-hover:opacity-90 transition-opacity"></div>
        <div class="absolute inset-0 p-6 flex flex-col justify-end">
      ...
      <!-- Installation Project 7 - Family Dentistry -->
      <div class="project-card group relative h-96 rounded-2xl overflow-hidden" data-category="installation">
        <img src="/static/images/project-installation-7.jpg" alt="Family Dentistry Monument Sign Installation" class="w-full h-full object-cover transition-transform duration-500 group-hover:scale-110">
        <div class="absolute inset-0 bg-gradient-to-t from-black via-black/60 to-transparent opacity-80 group-hover:opacity-90 transition-opacity"></div>
        <div class="absolute inset-0 p-6 flex flex-col justify-end">

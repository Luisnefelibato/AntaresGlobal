    ...
    <div class="flex justify-between items-center h-16 lg:h-20">
      ...
      <div class="hidden lg:flex items-center space-x-3">
        ...
        <div class="flex items-center space-x-1 border border-white/10 rounded-lg p-1">
          <button class="lang-btn px-3 py-1.5 text-xs font-medium rounded transition-colors flex items-center gap-1.5" data-lang="en" data-i18n="nav.en">
            <svg class="w-4 h-3" viewBox="0 0 640 480" xmlns="http://www.w3.org/2000/svg">
          ...
          <button class="lang-btn px-3 py-1.5 text-xs font-medium rounded transition-colors flex items-center gap-1.5" data-lang="es" data-i18n="nav.es">
            <svg class="w-4 h-3" viewBox="0 0 640 480" xmlns="http://www.w3.org/2000/svg">
  ...
  <div id="mobile-menu" class="hidden lg:hidden border-t border-white/5">
    <div class="px-4 pt-2 pb-4 space-y-1">
      ...
      <div class="pt-3 pb-2 flex items-center justify-center space-x-2">
        <button class="lang-btn px-4 py-2 text-sm font-medium rounded-lg border border-white/10 transition-colors flex items-center gap-2" data-lang="en">
          <svg class="w-5 h-4" viewBox="0 0 640 480" xmlns="http://www.w3.org/2000/svg">
            <path fill="#bd3d44" d="M0 0h640v480H0"/>
            <path stroke="#fff" stroke-width="37" d="M0 55.3h640M0 129h640M0 203h640M0 277h640M0 351h640M0 425h640"/>
            <path fill="#192f5d" d="M0 0h364.8v258.5H0"/>
            <marker id="us-b" markerHeight="30" markerWidth="30">
              <path fill="#fff" d="m14 0 9 27L0 10h28L5 27z"/>
            </marker>
            <path fill="none" marker-mid="url(#us-b)" d="m0 0 16 11h61 61 61 61 60L47 37h61 61 60 61L16 63h61 61 61 61 60L47 89h61 61 60 61L16 115h61 61 61 61 60L47 141h61 61 60 61L16 166h61 61 61 61 60L47 192h61 61 60 61L16 218h61 61 61 61 60z"/>
          </svg>
          EN
        </button>
        <button class="lang-btn px-4 py-2 text-sm font-medium rounded-lg border border-white/10 transition-colors flex items-center gap-2" data-lang="es">
          <svg class="w-5 h-4" viewBox="0 0 640 480" xmlns="http://www.w3.org/2000/svg">
            <path fill="#c60b1e" d="M0 0h640v480H0z"/>
            <path fill="#ffc400" d="M0 120h640v240H0z"/>
          </svg>
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 lg:gap-12">
      ...
      <div class="col-span-1 md:col-span-2 lg:col-span-1">
        ...
        <div class="flex items-center space-x-4">
          <a href="tel:+16893312690" class="text-white/60 hover:text-antares-blue transition-colors">
            <svg class="w-5 h-5" fill="currentColor" viewBox="0 0 20 20">
              <path d="M2 3a1 1 0 011-1h2.153a1 1 0 01.986.836l.74 4.435a1 1 0 01-.54 1.06l-1.548.773a11.037 11.037 0 006.105 6.105l.774-1.548a1 1 0 011.059-.54l4.435.74a1 1 0 01.836.986V17a1 1 0 01-1 1h-2C7.82 18 2 12.18 2 5V3z"/>
            </svg>
          </a>
          <a href="mailto:contacto@antaresinnovate.com" class="text-white/60 hover:text-antares-blue transition-colors">
            <svg class="w-5 h-5" fill="currentColor" viewBox="0 0 20 20">
